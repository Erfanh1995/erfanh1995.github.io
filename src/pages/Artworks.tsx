...
const Artworks: React.FC = () => {
  const artworkItems = [
    ...
    },
    {
      ...
      year: '2016 - Present',
      description: 'This is a group of artworks that grows by time. Distinguished by the common dark gray background and theme with geometricshapes and patterns.',
      tags: ['Digital Art'],
      image: '/personal.jpg',
    },
    {
    ...
    {
        title: 'The 9th AUT 10-day of Mathematics Posters',
        medium: 'Posters',
        year: '2015',
        description: 'Posters for the 9th AUT 10-day of Mathematics, a celebration of mathematics and its applications.',
    ...
    },
    {
        ...
        medium: 'Icon',
        year: '2015',
        description: 'A Logo for the AUT Annual 10-day of Mathematics.',
